...
@section('title','Date: '. date('Y-m-d'). ' - Vacation: ' . App\Shift::SHIFT_SELECT[getShift()])
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <dl class="row mb-0">
          ...
          <dd class="mb-1 col-sm-9"><span class="user-tag bg-primary">Active</span></dd>
        </dl>
      ...
      <div class="col-md-6">
        ...
        @if ($shift->chefE())
        <dl class="row mb-0">
          <dt class="col-sm-3">Chef d'equipe:</dt>
...
<!-- Les Interventions -->
<x-table title="Les 5 derniers interventions" :link="route('events.index')">
...
<x-table title="Les 5 derniers arrêts et coupures" :link="route('lines.index')">
