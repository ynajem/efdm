      ...
      <div class="col-12">
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <!-- Font Awesome icons -->
            <div class="tab-pane active show" id="fa-icons">
              <section>
                <div class="col-12">
                  <div class="row">
                    <div class=" col-md-4 list-group mt-3">
