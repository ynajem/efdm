    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-lg-12">
            <div class="m-b-md">
              <a href="#" class="btn btn-dark btn-xs float-right">Modifier</a>
              <h2>Vacation 14h00 - 21h00 [02/04/2020]</h2>
            </div>
          ...
          <div class="col-lg-6">
            <dl class="row mb-0">
              ...
              <div class="col-sm-8 text-sm-left">
                <dd class="mb-1"><span class="badge badge-primary">Active</span></dd>
              </div>
            </dl>
            <dl class="row mb-0">
              <div class="col-sm-4 text-sm-right">
              ...
              <div class="col-sm-8 text-sm-left">
                <dd class="mb-1">Najem Youness</dd>
              </div>
            </dl>
            <dl class="row mb-0">
              <div class="col-sm-4 text-sm-right">
            ...
            <dl class="row mb-0">
              ...
              <div class="col-sm-8 text-sm-left">
                <dd class="project-people mb-1">
                  <a href=""><img alt="image" class="rounded-circle" src="imgs/user1.png"></a>
